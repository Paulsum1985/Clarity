        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <GlassCard className="w-full max-w-sm text-center relative">
                ...
                <div className="space-y-4">
                    ...
                    <button onClick={() => handleSignIn(new OAuthProvider('apple.com'))} className="w-full flex items-center justify-center gap-3 bg-white/10 hover:bg-white/20 text-white font-semibold py-3 px-4 rounded-lg transition-colors">
                    <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
    <path d="M17.252 14.04c-.052.002-.105.002-.159.002h-.035c-1.31 0-2.029-.638-3.033-1.853-.94-1.144-1.637-2.45-1.637-3.693 0-1.285.83-2.502 2.016-3.413 1.023-.795 2.143-1.228 3.266-1.228.056 0 .11-.002.164-.002.13 0 .26-.002.39-.002.046 0 .092.002.14.002 1.343 0 2.072.652 3.033 1.854 1.01 1.214 1.638 2.45 1.638 3.693 0 1.285-.83 2.502-2.017 3.413-1.021.794-2.142 1.228-3.266 1.228a1.59 1.59 0 01-.157-.002zM12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm-2.054 18.256c.018-.002.036-.005.054-.007.228-.016.456-.04.68-.073.23-.035.458-.08.683-.134.453-.11.894-.265 1.32-.464.44-.206.84-.467 1.218-.782.355-.294.66-.62.91-.98.24-.35.42-.722.53-1.12.11-.39.15-.78.15-1.173s-.04-1.04-.15-1.432c-.11-.398-.29-.77-.53-1.12-.25-.36-.555-.686-.91-.98-.378-.315-.778-.576-1.218-.782-.425-.2-.867-.354-1.32-.464-.225-.054-.453-.1-.683-.135-.224-.033-.45-.057-.68-.073a.85.85 0 00-.054-.006c-.018.002-.036.005-.054.006-.228.016-.456.04-.68.073-.23.035-.458-.08-.683-.135-.453.11-.894.264-1.32-.464-.44.206-.84.467-1.218-.782-.355.294-.66-.62-.91-.98-.24.35-.42.722-.53 1.12-.11.392-.15.782-.15 1.173s.04 1.04.15 1.432c.11.398.29.77.53 1.12.25.36.555.686.91.98.378.315.778.576 1.218.782.425.2.867.354 1.32.464.225.054.453.1.683.134.224.033.45.057.68.073.018.002.036.005.054.007z"/>
</svg>
    Sign in with Apple
</button>
                </div>
